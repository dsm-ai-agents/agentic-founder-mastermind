...
Identify the top 2-3 ICP buckets most likely to buy this service. For each ICP, give: ideal company type, decision-maker job titles, top 3 pain points, Google boolean search, LinkedIn Boolean search, a simplified LinkedIn search, Apollo search criteria, and a simplified Apollo search. Keep everything practical end search-ready so we can immediately extract leads from LinkedIn or Apollo and use the pain-points for-personalized outreach.
